# Exemple de human-colours en Python
# Voir https://github.com/vasilisvg/human-colours
# Exécutez ce script dans DrawBot (drawbot.com)

from fr_fr import hueName, saturationName, lightnessName
...
for i in range(10):
    ...
    t = 'Un rectangle %s, %s, %s\nsur un arrière-plan %s, %s, %s' % \
