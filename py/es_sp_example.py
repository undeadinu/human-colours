# Ejemplo de human-colours en Python
# Fuente https://github.com/vasilisvg/human-colours
# Ejecutar este script en DrawBot (drawbot.com)

from es_sp import hueName, saturationName, lightnessName
